...
> environment actions. Release 3+ work is deferred.
...
2. The Release 2 workstream and progress trackers.
3. Dated release-readiness or production-review evidence.
4. Story notes and iteration logs, which preserve historical decisions and context.
...
4. Treat unchecked manual checks and the remediation queue as follow-up work, even when the corresponding release implementation is marked complete.
