...
the [main PRD](2026-07-27-fin-buddy-prd.md). For implementation status, read the
[Release 2 index](release-2/README.md), then [progress](release-2/PROGRESS.md)
and the [workstream exit criteria](RELEASE-2-TASKS.md#release-2-exit-criteria).
