...
| 2026-09-08 | US-P05 | `done` | RFC 9440 Idempotency-Key engine with SHA-256 payload hashing and cached response replay; row-level locking (with_for_update) across reversals, drafts, EMIs, obligations, statements, and balance corrections; partial unique index on reversals; 9 real PostgreSQL concurrency/race tests passed; 257 backend and 18 frontend tests passed; Turbopack build clean; preflight and post-task clean. US-P05 complete; US-P06 queued. |
