...
- [x] **US-06.I2** Export API + Settings download button.
- [x] **US-06.I3** Frontend import UI accepts CSV/xlsx with format hints — **impeccable craft-floor**; keep review flow calm and dense.
