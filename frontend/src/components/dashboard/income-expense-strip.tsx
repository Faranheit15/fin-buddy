...
export function IncomeExpenseStrip({ incomePaise, expensePaise }: IncomeExpenseStripProps) {
  return (
    <div className="grid gap-4 sm:grid-cols-2">
      ...
      <Card className="shadow-sm ring-1 ring-foreground/10">
        <CardContent className="flex items-center justify-between p-4">
          <div>
            <p className="text-xs font-medium text-muted-foreground">Period expenses</p>
            <p className="mt-1 font-mono text-lg font-semibold tracking-tight text-foreground tabular-nums">
